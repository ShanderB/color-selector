...
describe('ColorPickerComponent', () => {
  ...
  const getByTestId = (id: string, compiled: { querySelector: (arg0: string) => any; }) => {
  ...
  const factory = (initialColor: string, colorOptions: string[]) => {
  ...
  it('Should render Initial UI', async () => {
    ...
    Array.from(colorOptions.children).forEach((node: any, i) => {
